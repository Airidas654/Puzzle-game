...
public class Deathtest : InputTestFixture
{
    ...
    public IEnumerator DeathWhenEnemyHitTest()
    {
        ...
        enemy.GetComponent<Enemy>().patrolPositions = new List<Vector2>();
        enemy.GetComponent<Enemy>().patrolPositions.Add(Vector2.up);
        enemy.GetComponent<Enemy>().patrolPositions.Add(Vector2.zero);
